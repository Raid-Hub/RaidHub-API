...
import { PantheonVersionReleaseDates, UrlPathsToPantheonVersion } from "../../../data/leaderboards"
import { cacheControl } from "../../../middlewares/cache-control"
import { prisma } from "../../../services/prisma"
import { ok } from "../../../util/response"
import { zLeaderboardQueryPagination, zPantheonPath, zWorldFirstLeaderboardEntry } from "../_schema"

export const pantheonFirstRoute = new RaidHubRoute({
    method: "get",
    params: z.object({
    ...
    async handler(req) {
        ...
        const date = PantheonVersionReleaseDates[version]
